...
BACKEND_VAL="${BACKEND:-false}"
KYLRIX_INTEGRATED_BACKEND=0
case "$BACKEND_VAL" in
  true|appwrite|integrated|1) KYLRIX_INTEGRATED_BACKEND=1 ;;
esac

emit KYLRIX_INTEGRATED_BACKEND "$KYLRIX_INTEGRATED_BACKEND"

...
Self-hosted? See [SELFHOST.md](../SELFHOST.md) for your instance URL.
...
Copy [`.cursor/mcp.json.example`](../.cursor/mcp.json.example) → `.cursor/mcp.json` (never commit tokens).
...
Mint PAT: **Settings → Developers** on [kylrix.space](https://www.kylrix.space).
...
- **PATs**: **Settings → Developers** (`kyl_pat_…`)
- **OAuth 2.1**: See [oauth2.md](./oauth2.md)

...
export type SessionObjectsCreate = {
    "userId": string;
    "sessionId": string;
    "objectId": string;
    "objectType": string;
...
export type FlowInstallsCreate = {
    "flowId": string;
    "installerId": string;
    "scopeKey": string;
...
export type PatRateStateCreate = {
    "patId": string;
    "userId": string;
    "minuteKey": string;
    "minuteCount"?: number;
...
export type ApiUserRateStateCreate = {
    "userId": string;
    "minuteKey": string;
    "minuteCount"?: number;
    "hourKey": string;
...
export type ThreadMessagesCreate = {
    "threadId": string;
    "userId": string;
...
export type ThreadReactionsCreate = {
    "messageId": string;
    "threadId": string;
    "userId": string;
    "emoji": string;
...
export type AgentByokKeysCreate = {
    "userId": string;
    "provider": string;
    "keyHint"?: string;
    "encryptedKey": string;
...
export type UserConvenienceSessionsCreate = {
    "userId": string;
  ...
  "passwordManagerDb": {
    ...
    "Session Objects": {
      create: (data: {
        ...
        "toolKey"?: string | null;
        "createdAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<SessionObjects>;
      get: (id: string) => Promise<SessionObjects>;
      update: (id: string, data: Partial<{
        "userId": string;
        "sessionId": string;
        "objectId": string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; notEqual: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; lessThan: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; lessThanEqual: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; greaterThan: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; greaterThanEqual: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; contains: <K extends QueryableKeys<SessionObjects>>(field: K, value: QueryableFieldValue<SessionObjects, K>) => string; search: <K extends QueryableKeys<SessionObjects>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<SessionObjects>>(field: K) => string; isNotNull: <K extends QueryableKeys<SessionObjects>>(field: K) => string; startsWith: <K extends QueryableKeys<SessionObjects>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<SessionObjects>>(field: K, value: string) => string; between: <K extends QueryableKeys<SessionObjects>>(field: K, start: QueryableFieldValue<SessionObjects, K>, end: QueryableFieldValue<SessionObjects, K>) => string; select: <K extends keyof SessionObjects>(fields: K[]) => string; orderAsc: <K extends keyof SessionObjects>(field: K) => string; orderDesc: <K extends keyof SessionObjects>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: SessionObjects[] }>;
    };
    "Tool Calls": {
      create: (data: {
        "userId": string;
      ...
      get: (id: string) => Promise<ToolCalls>;
      update: (id: string, data: Partial<{
        "userId": string;
        "sessionId": string;
        "conversationId": string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; notEqual: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; lessThan: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; lessThanEqual: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; greaterThan: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; greaterThanEqual: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; contains: <K extends QueryableKeys<ToolCalls>>(field: K, value: QueryableFieldValue<ToolCalls, K>) => string; search: <K extends QueryableKeys<ToolCalls>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<ToolCalls>>(field: K) => string; isNotNull: <K extends QueryableKeys<ToolCalls>>(field: K) => string; startsWith: <K extends QueryableKeys<ToolCalls>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<ToolCalls>>(field: K, value: string) => string; between: <K extends QueryableKeys<ToolCalls>>(field: K, start: QueryableFieldValue<ToolCalls, K>, end: QueryableFieldValue<ToolCalls, K>) => string; select: <K extends keyof ToolCalls>(fields: K[]) => string; orderAsc: <K extends keyof ToolCalls>(field: K) => string; orderDesc: <K extends keyof ToolCalls>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: ToolCalls[] }>;
    };
    "flow_installs": {
      create: (data: {
        "flowId": string;
    ...
    "flow_reviews": {
      ...
      get: (id: string) => Promise<FlowReviews>;
      update: (id: string, data: Partial<{
        "flowId": string;
        "actorId": string;
        "sessionId"?: string | null;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; notEqual: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; lessThan: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; lessThanEqual: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; greaterThan: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; greaterThanEqual: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; contains: <K extends QueryableKeys<FlowReviews>>(field: K, value: QueryableFieldValue<FlowReviews, K>) => string; search: <K extends QueryableKeys<FlowReviews>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<FlowReviews>>(field: K) => string; isNotNull: <K extends QueryableKeys<FlowReviews>>(field: K) => string; startsWith: <K extends QueryableKeys<FlowReviews>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<FlowReviews>>(field: K, value: string) => string; between: <K extends QueryableKeys<FlowReviews>>(field: K, start: QueryableFieldValue<FlowReviews, K>, end: QueryableFieldValue<FlowReviews, K>) => string; select: <K extends keyof FlowReviews>(fields: K[]) => string; orderAsc: <K extends keyof FlowReviews>(field: K) => string; orderDesc: <K extends keyof FlowReviews>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: FlowReviews[] }>;
    };
    "pats": {
      create: (data: {
        "userId": string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; notEqual: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; lessThan: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; lessThanEqual: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; greaterThan: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; greaterThanEqual: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; contains: <K extends QueryableKeys<Pats>>(field: K, value: QueryableFieldValue<Pats, K>) => string; search: <K extends QueryableKeys<Pats>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<Pats>>(field: K) => string; isNotNull: <K extends QueryableKeys<Pats>>(field: K) => string; startsWith: <K extends QueryableKeys<Pats>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<Pats>>(field: K, value: string) => string; between: <K extends QueryableKeys<Pats>>(field: K, start: QueryableFieldValue<Pats, K>, end: QueryableFieldValue<Pats, K>) => string; select: <K extends keyof Pats>(fields: K[]) => string; orderAsc: <K extends keyof Pats>(field: K) => string; orderDesc: <K extends keyof Pats>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: Pats[] }>;
    };
    "pat_rate_state": {
      create: (data: {
        "patId": string;
        ...
        "hourCount"?: number;
        "updatedAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<PatRateState>;
      get: (id: string) => Promise<PatRateState>;
      update: (id: string, data: Partial<{
        "patId": string;
        "userId": string;
        "minuteKey": string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; notEqual: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; lessThan: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; lessThanEqual: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; greaterThan: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; greaterThanEqual: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; contains: <K extends QueryableKeys<PatRateState>>(field: K, value: QueryableFieldValue<PatRateState, K>) => string; search: <K extends QueryableKeys<PatRateState>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<PatRateState>>(field: K) => string; isNotNull: <K extends QueryableKeys<PatRateState>>(field: K) => string; startsWith: <K extends QueryableKeys<PatRateState>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<PatRateState>>(field: K, value: string) => string; between: <K extends QueryableKeys<PatRateState>>(field: K, start: QueryableFieldValue<PatRateState, K>, end: QueryableFieldValue<PatRateState, K>) => string; select: <K extends keyof PatRateState>(fields: K[]) => string; orderAsc: <K extends keyof PatRateState>(field: K) => string; orderDesc: <K extends keyof PatRateState>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: PatRateState[] }>;
    };
    "api_user_rate_state": {
      create: (data: {
        "userId": string;
        ...
        "hourCount"?: number;
        "updatedAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<ApiUserRateState>;
      get: (id: string) => Promise<ApiUserRateState>;
      update: (id: string, data: Partial<{
        "userId": string;
        "minuteKey": string;
        "minuteCount"?: number;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; notEqual: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; lessThan: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; lessThanEqual: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; greaterThan: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; greaterThanEqual: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; contains: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: QueryableFieldValue<ApiUserRateState, K>) => string; search: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<ApiUserRateState>>(field: K) => string; isNotNull: <K extends QueryableKeys<ApiUserRateState>>(field: K) => string; startsWith: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<ApiUserRateState>>(field: K, value: string) => string; between: <K extends QueryableKeys<ApiUserRateState>>(field: K, start: QueryableFieldValue<ApiUserRateState, K>, end: QueryableFieldValue<ApiUserRateState, K>) => string; select: <K extends keyof ApiUserRateState>(fields: K[]) => string; orderAsc: <K extends keyof ApiUserRateState>(field: K) => string; orderDesc: <K extends keyof ApiUserRateState>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: ApiUserRateState[] }>;
    };
    "oauth_apps": {
      create: (data: {
        "ownerId": string;
    ...
    "threads": {
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; notEqual: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; lessThan: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; lessThanEqual: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; greaterThan: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; greaterThanEqual: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; contains: <K extends QueryableKeys<Threads>>(field: K, value: QueryableFieldValue<Threads, K>) => string; search: <K extends QueryableKeys<Threads>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<Threads>>(field: K) => string; isNotNull: <K extends QueryableKeys<Threads>>(field: K) => string; startsWith: <K extends QueryableKeys<Threads>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<Threads>>(field: K, value: string) => string; between: <K extends QueryableKeys<Threads>>(field: K, start: QueryableFieldValue<Threads, K>, end: QueryableFieldValue<Threads, K>) => string; select: <K extends keyof Threads>(fields: K[]) => string; orderAsc: <K extends keyof Threads>(field: K) => string; orderDesc: <K extends keyof Threads>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: Threads[] }>;
    };
    "thread_messages": {
      create: (data: {
        "threadId": string;
      ...
      get: (id: string) => Promise<ThreadMessages>;
      update: (id: string, data: Partial<{
        "threadId": string;
        "userId": string;
        "parentMessageId"?: string | null;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; notEqual: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; lessThan: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; lessThanEqual: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; greaterThan: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; greaterThanEqual: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; contains: <K extends QueryableKeys<ThreadMessages>>(field: K, value: QueryableFieldValue<ThreadMessages, K>) => string; search: <K extends QueryableKeys<ThreadMessages>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<ThreadMessages>>(field: K) => string; isNotNull: <K extends QueryableKeys<ThreadMessages>>(field: K) => string; startsWith: <K extends QueryableKeys<ThreadMessages>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<ThreadMessages>>(field: K, value: string) => string; between: <K extends QueryableKeys<ThreadMessages>>(field: K, start: QueryableFieldValue<ThreadMessages, K>, end: QueryableFieldValue<ThreadMessages, K>) => string; select: <K extends keyof ThreadMessages>(fields: K[]) => string; orderAsc: <K extends keyof ThreadMessages>(field: K) => string; orderDesc: <K extends keyof ThreadMessages>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: ThreadMessages[] }>;
    };
    "thread_reactions": {
      create: (data: {
        "messageId": string;
        ...
        "emoji": string;
        "createdAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<ThreadReactions>;
      get: (id: string) => Promise<ThreadReactions>;
      update: (id: string, data: Partial<{
        "messageId": string;
        "threadId": string;
        "userId": string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; notEqual: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; lessThan: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; lessThanEqual: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; greaterThan: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; greaterThanEqual: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; contains: <K extends QueryableKeys<ThreadReactions>>(field: K, value: QueryableFieldValue<ThreadReactions, K>) => string; search: <K extends QueryableKeys<ThreadReactions>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<ThreadReactions>>(field: K) => string; isNotNull: <K extends QueryableKeys<ThreadReactions>>(field: K) => string; startsWith: <K extends QueryableKeys<ThreadReactions>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<ThreadReactions>>(field: K, value: string) => string; between: <K extends QueryableKeys<ThreadReactions>>(field: K, start: QueryableFieldValue<ThreadReactions, K>, end: QueryableFieldValue<ThreadReactions, K>) => string; select: <K extends keyof ThreadReactions>(fields: K[]) => string; orderAsc: <K extends keyof ThreadReactions>(field: K) => string; orderDesc: <K extends keyof ThreadReactions>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: ThreadReactions[] }>;
    };
    "agent_byok_keys": {
      create: (data: {
        "userId": string;
        ...
        "encryptedKey": string;
        "enabled"?: boolean;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<AgentByokKeys>;
      get: (id: string) => Promise<AgentByokKeys>;
      update: (id: string, data: Partial<{
        "userId": string;
        "provider": string;
        "keyHint"?: string;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; notEqual: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; lessThan: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; lessThanEqual: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; greaterThan: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; greaterThanEqual: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; contains: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: QueryableFieldValue<AgentByokKeys, K>) => string; search: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<AgentByokKeys>>(field: K) => string; isNotNull: <K extends QueryableKeys<AgentByokKeys>>(field: K) => string; startsWith: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<AgentByokKeys>>(field: K, value: string) => string; between: <K extends QueryableKeys<AgentByokKeys>>(field: K, start: QueryableFieldValue<AgentByokKeys, K>, end: QueryableFieldValue<AgentByokKeys, K>) => string; select: <K extends keyof AgentByokKeys>(fields: K[]) => string; orderAsc: <K extends keyof AgentByokKeys>(field: K) => string; orderDesc: <K extends keyof AgentByokKeys>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: AgentByokKeys[] }>;
    };
    "user_convenience_sessions": {
      create: (data: {
        "userId": string;
        "encryptedUserMek": string;
        "expiresAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<UserConvenienceSessions>;
      get: (id: string) => Promise<UserConvenienceSessions>;
      update: (id: string, data: Partial<{
        "userId": string;
        "encryptedUserMek": string;
        "expiresAt"?: string | null;

...
export function buildSidekickSystemInstruction(target: SidekickTarget): string {
  return [
    ...
    'If the user asks a question, answer it clearly using markdown. If the user asks to create an object (form, goal, note, event, project) or if an action is performed, provide a clear, formatted explanation along with structured suggestions or next steps.',

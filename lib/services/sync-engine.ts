...
import { flushGoalPending as flushGoalPending_ext } from './sync-engineSections/flushGoalPending';
import { flushNotePending as flushNotePending_ext } from './sync-engineSections/flushNotePending';
...
const flushGoalPending = (..._args: any[]) => flushGoalPending_ext({ dataPayload, delay, flushGoalPending, flushNotePending, flushRevision, handleUserActivity, liveAfter, liveRev, now, queuedAfter, t });

const flushNotePending = (..._args: any[]) => flushNotePending_ext({ dataPayload, delay, flushGoalPending, flushNotePending, flushRevision, handleUserActivity, liveAfter, liveRev, now, queuedAfter, t });

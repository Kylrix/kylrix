...
export const CURATED_TOPIC_CATEGORIES: TopicCategory[] = [
  ...
  {
    id: 'crypto_finance',
    label: 'Crypto & Sovereign Finance',
    description: 'Decentralized settlement, sound money, and autonomous economics',
    topics: [
      { id: 'bitcoin', label: 'Bitcoin', tag: 'bitcoin' },
      { id: 'ethereum', label: 'Ethereum', tag: 'ethereum' },
      { id: 'solana', label: 'Solana', tag: 'solana' },
      { id: 'defi', label: 'DeFi & Payments', tag: 'defi' },

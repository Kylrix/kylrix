                    ...
                    <Stack spacing={4}>
                        ...
                        <Box id="google-workspace-settings" sx={{ transition: 'all 0.5s ease', borderRadius: '28px', border: '1px solid transparent' }}>
                            <Typography variant="h6" sx={{ fontWeight: 800, mb: 2, display: 'flex', alignItems: 'center', gap: 1.25, color: 'white' }}>
                                <Link size={20} style={{ marginRight: 8, color: '#6366F1' }} />
                                 ...
                                 <Stack spacing={3}>
                                     <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                         <Box sx={{ display: 'flex', gap: 2, alignItems: 'flex-start', pr: 2 }}>
                                             <Box sx={{ mt: 0.5, display: 'flex', alignItems: 'center', justifyContent: 'center', width: 36, height: 36, borderRadius: '10px', bgcolor: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.05)', flexShrink: 0 }}>

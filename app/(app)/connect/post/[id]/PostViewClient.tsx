...
import { CommentMomentRow as CommentMomentRow_ext } from './PostViewClientSections/CommentMomentRow';
...
const CommentMomentRow = (..._args: any[]) => CommentMomentRow_ext({ CommentMomentRow, avatarUrl, busy, c, creator, d, dualNostrId, engagementDrawer, eventType, first, handle, handleBack, handleShare, isNostr, isReaction, isReply, isRepost, liked, likes, loading, moment, momentId, nostrEvent, nostrKind, onRepost, onZap, openCommentProfile, openReplyComposer, params, parentEvent, parentLoading, parsed, parts, preview, rawBody, rawId, reactionContent, ref, replies, reply, reposted, reposts, root, router, setBusy, setCreator, setEngagementDrawer, setLiked, setLikes, setLoading, setMoment, setMomentId, setNostrEvent, setParentEvent, setParentLoading, setReplies, setReposted, setReposts, setSource, setZaps, showParent, source, toggleLike, who, zaps });

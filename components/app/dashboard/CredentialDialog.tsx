...
import {
import { buildCredentialData as buildCredentialData_ext } from './CredentialDialogSections/buildCredentialData';
import { hydrate as hydrate_ext } from './CredentialDialogSections/hydrate';
...
export default function CredentialDialog({
  ...
  useEffect(() => {
    ...
    const hydrate = (..._args: any[]) => hydrate_ext({ addCustomField, applyEnvText, attachments, buildCredentialData, credentialForm, currentType, customFields, draftReady, draftTimerRef, envHint, error, fileInputRef, form, handleClose, handleDeleteAttachment, handleEnvFile, handleGeneratePassword, handleMorphToDetail, handlePasteEnv, handleSubmit, handleUploadAttachment, hydrate, isEnvMode, isExpanded, isMobile, isNameManuallyEdited, loading, removeCustomField, resolveSecretName, setAttachments, setCustomFields, setDraftReady, setEnvHint, setError, setForm, setIsEnvMode, setIsExpanded, setIsMobile, setIsNameManuallyEdited, setLoading, setShowPassword, setUploadingAttachment, showLoginFields, showPassword, syncNameFromUsername, updateCustomField, uploadingAttachment });
  ...
  const buildCredentialData = (..._args: any[]) => buildCredentialData_ext({ addCustomField, applyEnvText, attachments, buildCredentialData, credentialForm, currentType, customFields, draftReady, draftTimerRef, envHint, error, fileInputRef, form, handleClose, handleDeleteAttachment, handleEnvFile, handleGeneratePassword, handleMorphToDetail, handlePasteEnv, handleSubmit, handleUploadAttachment, hydrate, isEnvMode, isExpanded, isMobile, isNameManuallyEdited, loading, removeCustomField, resolveSecretName, setAttachments, setCustomFields, setDraftReady, setEnvHint, setError, setForm, setIsEnvMode, setIsExpanded, setIsMobile, setIsNameManuallyEdited, setLoading, setShowPassword, setUploadingAttachment, showLoginFields, showPassword, syncNameFromUsername, updateCustomField, uploadingAttachment });

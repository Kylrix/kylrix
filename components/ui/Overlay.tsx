    ...
    <Drawer
      ...
      PaperProps={{
        sx: {
          ...
          height: drawerHeight,
          maxHeight: isMobile && !isFlapover ? (isProfileSidebar ? (isExpanded ? '100dvh' : '60vh') : (isExpanded ? '100dvh' : '60dvh')) : '100dvh',
          overflowX: 'hidden',
          overflowY: 'hidden',
          borderTopLeftRadius: isMobile && !isFlapover ? '28px' : 0,
          borderTopRightRadius: isMobile && !isFlapover ? '28px' : 0,

              ...
              {titleNode ?? (
                <span
                  className={[
                    ...
                    isTask
                      ? 'text-[0.9375rem] font-semibold font-satoshi tracking-[-0.01em] text-white'
          ...
          {children ?? (
            <p
              className={[
                ...
                isTask
                  ? 'text-white text-[0.8125rem] leading-snug line-clamp-2 font-medium'
                  : 'text-white text-[0.8125rem] sm:text-sm font-medium leading-relaxed line-clamp-3',
        ...
        {footer ? (
          <div
            className={[
              ...
              isTask ? 'pl-9 border-t border-white/[0.08] pt-2' : 'border-t border-white/[0.08]',
              leading ? '' : '',
            ].join(' ')}
            onClick={(e) => e.stopPropagation()}
          >

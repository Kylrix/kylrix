...
export default function ConnectTopbar({
  ...
  const renderProfilePanel = () => {
    ...
    const profileBody = (
      <Box sx={{ display: 'grid', gap: { xs: 1.5, sm: 2 }, minWidth: 0, width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
        {/* 1. Identity Tile */}
        <Box sx={{ p: { xs: 1.75, sm: 2 }, borderRadius: '20px', border: '1px solid rgba(255,255,255,0.08)', bgcolor: 'rgba(255,255,255,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 1.5, minWidth: 0, maxWidth: '100%', boxSizing: 'border-box' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, minWidth: 0, flex: 1, overflow: 'hidden' }}>
            ...
            <Box sx={{ minWidth: 0, flex: 1, overflow: 'hidden' }}>
              <Box
                ...
                sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 0, bgcolor: 'transparent', border: 'none', cursor: 'pointer', textAlign: 'left', minWidth: 0, width: '100%', maxWidth: '100%' }}
              >
                <Typography component="span" sx={{ color: 'white', fontWeight: 900, fontSize: { xs: '0.92rem', sm: '1rem' }, lineHeight: 1.2, fontFamily: 'var(--font-clash)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0, flex: 1, '&:hover': { color: '#818CF8' } }}>
                  {primaryHandle}
                </Typography>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5, minWidth: 0, maxWidth: '100%', overflow: 'hidden' }}>
                <Box component="span" sx={{ fontSize: '9px', fontFamily: 'monospace', px: 1, py: 0.25, borderRadius: '999px', bgcolor: 'rgba(236,72,153,0.15)', color: '#EC4899', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em', flexShrink: 0 }}>
                  {currentTier} PLAN
                </Box>
                {profileUsername && profileDisplayName && profileDisplayName !== profileUsername && (
                  <Typography component="span" sx={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0, flex: 1 }}>
                    {profileDisplayName}
                  </Typography>
                )}
                {!profileUsername && (
        ...
        <Box sx={{ p: { xs: 1.75, sm: 2 }, borderRadius: '20px', border: '1px solid rgba(255,255,255,0.08)', bgcolor: 'rgba(255,255,255,0.03)', display: 'flex', flexDirection: 'column', gap: 1.25, minWidth: 0, maxWidth: '100%', boxSizing: 'border-box' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 1, minWidth: 0, maxWidth: '100%' }}>
            <Typography component="span" sx={{ color: 'rgba(255,255,255,0.6)', fontSize: '10.5px', fontWeight: 900, fontFamily: 'monospace', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'flex', alignItems: 'center', gap: 0.75, minWidth: 0, flex: 1, overflow: 'hidden' }}>
            ...
            <Box component="span" sx={{ fontSize: '9.5px', fontFamily: 'monospace', color: '#10B981', bgcolor: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.2)', px: 1, py: 0.25, borderRadius: '6px', fontWeight: 800, flexShrink: 0 }}>
              +1.5 $KYL / join
            </Box>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, bgcolor: 'rgba(0,0,0,0.45)', p: { xs: 0.75, sm: 1 }, borderRadius: '14px', border: '1px solid rgba(255,255,255,0.06)', minWidth: 0, maxWidth: '100%', overflow: 'hidden', boxSizing: 'border-box' }}>
            <Typography component="span" sx={{ color: 'rgba(255,255,255,0.85)', fontFamily: 'monospace', fontSize: '11.5px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flex: 1, minWidth: 0, px: 0.5, userSelect: 'all' }}>
            ...
            <Box
              ...
              sx={{ px: 2, py: 0.7, borderRadius: '8px', fontSize: '11px', fontWeight: 900, color: 'white', bgcolor: copyState === 'copied-referral' ? '#10B981' : '#6366F1', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 0.5, transition: 'all 0.2s', flexShrink: 0, '&:hover': { bgcolor: copyState === 'copied-referral' ? '#10B981' : '#5254E8' } }}
            >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.25, pt: 0.25, minWidth: 0, maxWidth: '100%' }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: { xs: 1, sm: 1.5 }, minWidth: 0, maxWidth: '100%' }}>
            <Button
              onClick={() => {
                handleCloseAll();
                openWallet();
              }}
              sx={{ minHeight: 44, borderRadius: '16px', bgcolor: alpha(appAccent, 0.08), border: `1px solid ${alpha(appAccent, 0.16)}`, color: appAccent, py: 1.25, fontSize: '0.86rem', textTransform: 'none', fontWeight: 800, minWidth: 0, overflow: 'hidden', '&:hover': { bgcolor: alpha(appAccent, 0.15) } }}
              startIcon={<Wallet size={15} style={{ flexShrink: 0 }} />}
            >
              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0 }}>Wallet</span>
            </Button>
            <Button
              onClick={() => {
                handleCloseAll();
              ...
              sx={{ minHeight: 44, borderRadius: '16px', bgcolor: 'rgba(255,255,255,0.03)', color: 'white', border: '1px solid rgba(255,255,255,0.08)', py: 1.25, fontSize: '0.86rem', textTransform: 'none', fontWeight: 800, minWidth: 0, overflow: 'hidden', '&:hover': { bgcolor: 'rgba(255,255,255,0.07)' } }}
              startIcon={<Settings size={15} style={{ flexShrink: 0 }} />}
            >
              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0 }}>Settings</span>
            </Button>
          </Box>
          ...
          {!isPro && (
            <Button
              ...
              sx={{ minHeight: 42, borderRadius: '16px', bgcolor: 'rgba(236,72,153,0.08)', color: '#EC4899', border: '1px solid rgba(236,72,153,0.22)', py: 1, fontSize: '0.84rem', textTransform: 'none', fontWeight: 800, minWidth: 0, overflow: 'hidden', '&:hover': { bgcolor: 'rgba(236,72,153,0.15)' } }}
              startIcon={<Sparkles size={14} style={{ flexShrink: 0 }} />}
            >
              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0 }}>Upgrade to Pro</span>
            </Button>
          )}
          ...
          <Button
            ...
            sx={{ minHeight: 44, borderRadius: '16px', bgcolor: 'rgba(255,77,77,0.06)', color: '#FF4D4D', border: '1px solid rgba(255,77,77,0.14)', py: 1.25, fontSize: '0.86rem', textTransform: 'none', fontWeight: 800, minWidth: 0, overflow: 'hidden', '&:hover': { bgcolor: 'rgba(255,77,77,0.12)' } }}
            startIcon={<LogOut size={15} style={{ flexShrink: 0 }} />}
          >
            <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', minWidth: 0 }}>Sign out</span>
          </Button>
        </Box>
      </Box>
    );
